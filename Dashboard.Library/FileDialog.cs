/**
 * By Mike Kukta
 * http://www.mikekukta.com/post/2011/12/06/Neoforce-Nugget-FileDialog-Class.aspx
 * 
 * Bugfixes/updates by Tony Peng
 * */

#warning quick fix for proof of concept -- probably want to rewrite
...
namespace Dashboard.Library
{
    public class FileDialog : Window
    {
            ...
            : base(manager)
        {
            ...
            filters.ItemAdded += new TomShane.Neoforce.Controls.EventHandler(filters_ItemAdded);
            filters.ItemRemoved += new TomShane.Neoforce.Controls.EventHandler(filters_ItemRemoved);
        }
        #endregion
        ...
        public override void Init()
        {
            ...
            Height = 375;
            Text = "Select File";
            ResizeEnd += new TomShane.Neoforce.Controls.EventHandler(OpenFileDialog_ResizeEnd);
            ...
            cmbDrives.ItemIndexChanged += new TomShane.Neoforce.Controls.EventHandler(cmbDrives_ItemIndexChanged);
            Add(cmbDrives);
            ...
            btnDirectoryUp.Click += new TomShane.Neoforce.Controls.EventHandler(btnDirectoryUp_Click);
            Add(btnDirectoryUp);
            ...
            lstFiles.DoubleClick += new TomShane.Neoforce.Controls.EventHandler(lstFiles_DoubleClick);
            lstFiles.ItemIndexChanged += new TomShane.Neoforce.Controls.EventHandler(lstFiles_ItemIndexChanged);
            ...
            btnOpen.Height = 25;
            btnOpen.Text = "Open";
            btnOpen.Click += new TomShane.Neoforce.Controls.EventHandler(btnOpen_Click);
            Add(btnOpen);
            ...
            btnCancel.Click += new TomShane.Neoforce.Controls.EventHandler(btnCancel_Click);
            Add(btnCancel);
        }
        #endregion
        ...
        private void EnumerateDirectories()
        {
            ...
            try
            {
                dirs = Directory.EnumerateDirectories(directory).ToList<string>();
            }
        ...
        private void EnumerateFiles()
        {
            ...
            try
            {
                files = Directory.EnumerateFiles(directory).ToList<string>();
            }
            catch (Exception e)
            {
                return;
        ...
        /// <param name="e"></param>
        void btnCancel_Click(object sender, TomShane.Neoforce.Controls.EventArgs e)
        {
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        void btnDirectoryUp_Click(object sender, TomShane.Neoforce.Controls.EventArgs e)
        {
            ...
            string cleanString = cmbDirectory.Text.Substring(0, index);
            index = cleanString.LastIndexOf(Path.DirectorySeparatorChar);
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        void cmbDrives_ItemIndexChanged(object sender, TomShane.Neoforce.Controls.EventArgs e)
        {
        ...
        void lstFiles_DoubleClick(object sender, TomShane.Neoforce.Controls.EventArgs e)
        {
            ...
            if (Directory.Exists(Path.Combine(cmbDirectory.Text, item)))
            {
                ...
                cmbDirectory.Text += Path.DirectorySeparatorChar;
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        void lstFiles_ItemIndexChanged(object sender, TomShane.Neoforce.Controls.EventArgs e)
        {
        ...
        void OpenFileDialog_ResizeEnd(object sender, TomShane.Neoforce.Controls.EventArgs e)
        {
            // Resize the controls so they expand with the dialog. 
            cmbDirectory.Width = (ClientWidth - cmbDirectory.Left - btnDirectoryUp.Width);
            btnDirectoryUp.Left = (ClientWidth - btnDirectoryUp.Width);
        ...
        void filters_ItemRemoved(object sender, TomShane.Neoforce.Controls.EventArgs e)
        {
            lstFiles.Items.Clear();
            EnumerateDirectories();
            EnumerateFiles();
        ...
        void filters_ItemAdded(object sender, TomShane.Neoforce.Controls.EventArgs e)
        {
            lstFiles.Items.Clear();
            EnumerateDirectories();
            EnumerateFiles();
